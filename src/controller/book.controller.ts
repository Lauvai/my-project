...
class BookController extends BaseController {
    ...
    getBook(req : express.Request, res : express.Response, next : express.NextFunction){
        ...
        validateSchema.validateAsync(id)
            .then((ValidatedBook) => {
                this.bookService
                .getBook(ValidatedBook)
                    .then((book) => {
    ...
    addBook(req: express.Request, res: express.Response, next: express.NextFunction) {
        const { body } = req;
        validateSchema.validateAsync(body)
          .then((ValidatedBook) => {    
            this.bookService
    ...
    initializeRoutes() {
        ...
        this.router.patch("/:id", this.updateBook.bind(this))
      }
}
